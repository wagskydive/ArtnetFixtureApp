...
- [ ] Tests Passed
- [x] Documentation Written
  - Updated `Assets/WebUI/webui.html` so `.modal-backdrop.hidden` always enforces `display: none`, preventing the modal backdrop `display: flex` rule from overriding hidden state.
